...
export default function PrepareScreen({ route, navigation }) {
    ...
    const handleStart = () => {
        if (Object.values(todos).every(v => v)) {
            navigation.navigate('InterviewScreen', { job, mode });
        }
    };
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <View style={{ marginTop: 20 }}>
                ...
                <View style={StyleShare.jobItemContainer}>
                    <Pressable
                        onPress={() => toggleTodo('prepareDevice')}
                        style={styles.checkboxContainer}
                    >
                ...
                <Modal isVisible={isModalVisible} onBackdropPress={() => setModalVisible(false)}
                    ...
                    <View style={styles.modalContent}>
                        ...
                        <TouchableOpacity
                            style={[styles.option]}
                            onPress={() => { setMode('text'); setModalVisible(false); }}
                        >
                        ...
                        <TouchableOpacity
                            style={[styles.option]}
                            onPress={() => { setMode('voice'); setModalVisible(false); }}
                        >
