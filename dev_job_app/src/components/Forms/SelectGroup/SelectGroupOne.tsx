...
interface SelectGroupOneProps {
  options: Option[]; // Prop nhận danh sách các lựa chọn
  initialOption?: string; // Prop nhận giá trị ban đầu
  onOptionChange?: (value: string) => void; // Prop callback cho sự kiện thay đổi lựa chọn
  lable: string
}
