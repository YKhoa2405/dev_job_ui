import { CircleCheckBigIcon, CircleX, Eye, Pencil, Plus, Search, TrashIcon } from 'lucide-react';
...
const Services = () => {
    ...
    const openModal = (id: string) => {
        fetchServiceDetail(id);  // Lấy chi tiết item theo ID
        setIsOpen(true);
    };

    const closeModal = () => {
        setIsOpen(false);
        setServiceDetail(null);  // Reset lại chi tiết
    };
