                    ...
                    <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                        <form onSubmit={handleCreateCompany}>
                            <div className="p-6.5">
                                ...
                                <div className="flex space-x-4 mb-4.5">
                                    <div className="flex-1">
                                        <label className="mb-2.5 block text-black dark:text-white">Logo <span className="text-meta-1">*</span></label>
                                        <input
                                            type="file"
                                            accept="image/*"
                                    ...
                                    <div className="flex-1">
                                        <label className="mb-2.5 block text-black dark:text-white">Website <span className="text-meta-1">*</span></label>
                                        <input
                                            type="url"
                                            value={website}
                                    ...
                                    <div className="flex-1">
                                        <label className="mb-2.5 block text-black dark:text-white">Quy mô <span className="text-meta-1">*</span></label>
                                        <select
                                            value={size}
                                ...
                                <div className="flex space-x-4 mb-4.5">
                                    ...
                                    <div className="flex-1">
                                        <label className="mb-2.5 block text-black dark:text-white">Lĩnh vực  <span className="text-meta-1">*</span></label>
                                        <input
                                            type="text"
                                            value={field}
