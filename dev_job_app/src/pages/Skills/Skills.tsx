...
const Skills = () => {
    ...
    const handleSearch = () => {
        fetchListSkill(1, 10, searchKeyword);
    };
    ...
    const fetchListSkill = async (currentPage = 1, limit = 10, name = '') => {
        setLoading(true)
        const searchQuery = name ? `/${name}/i` : '';
        try {
            const res = await API.get(endpoints['skills'], { // Update the endpoint as needed
                params: {
                    page: currentPage,
                    limit: limit,
                    name: searchQuery,
            ...
            setSkillData(data.result); // Update company data
                ...
                <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                    <div className="py-6 px-4 md:px-6 xl:px-7.5">
                        <div className="flex items-center justify-between">
                            <h4 className="text-xl font-semibold text-black dark:text-white">Danh sách công nghệ tuyển dụng</h4>
                            <button
                                onClick={openModal}
                                type='button'
                                ...
                                >
                                    ...
                                    <div className="col-span-1 hidden sm:flex items-center">
                                        <div className="flex items-center space-x-3.5">
                                            ...
                                            <button onClick={() => handleDeleteSkills(item._id)} className="hover:text-red-500">
                                                <TrashIcon size={20} />
                                            </button>
                    ...
                    <div className="py-6 px-4 md:px-6 xl:px-7.5 border-t border-stroke dark:border-strokedark">
                        <div className="flex items-center justify-between">
                            <h6 className="text-base font-semibold text-black dark:text-white">Tổng {totalItems} công nghệ </h6>
